...
int test44(void) {
    ...
    my_assert(44, 1, inc_44_global_var_and_return_true() ? inc_44_global_var_and_return_true() : inc_44_global_var_and_return_false());
    my_assert(44, 2, test44_global_var);
    my_assert(44, 0, inc_44_global_var_and_return_false() ? inc_44_global_var_and_return_true() : 0);
    my_assert(44, 3, test44_global_var);
    my_assert(44, 0, inc_44_global_var_and_return_false() ? 1 : inc_44_global_var_and_return_false());
...
int test45(void) {
    my_assert(45, 1, inc_45_global_var_and_return_true() && inc_45_global_var_and_return_true());
    my_assert(45, 2, test45_global_var);
    my_assert(45, 1, inc_45_global_var_and_return_true() || inc_45_global_var_and_return_true());
    my_assert(45, 3, test45_global_var);
    my_assert(45, 1, inc_45_global_var_and_return_false() || inc_45_global_var_and_return_true());
    my_assert(45, 5, test45_global_var);
    my_assert(45, 0, inc_45_global_var_and_return_false() && inc_45_global_var_and_return_true());
    my_assert(45, 6, test45_global_var);
    my_assert(45, 0, inc_45_global_var_and_return_true() && inc_45_global_var_and_return_false());
...
int test56(void) {
    my_assert(56, 0, strncmp(test56_strings[0], "red", sizeof("red") / sizeof(char)));
    my_assert(56, 0, strncmp(test56_strings[1], "green", sizeof("green") / sizeof(char)));
    my_assert(56, 0, strncmp(test56_strings[2], "blue", sizeof("blue") / sizeof(char)));
    my_assert(56, 0, strncmp(test56_strings[3], "really_long_string_more_than_eight", sizeof("really_long_string_more_than_eight") / sizeof(char)));
    ...
    my_assert(56, 0, strncmp(local_strings[0], "local_red", sizeof("local_red") / sizeof(char)));
    my_assert(56, 0, strncmp(local_strings[1], "local_green", sizeof("local_green") / sizeof(char)));
    my_assert(56, 0, strncmp(local_strings[2], "local_blue", sizeof("local_blue") / sizeof(char)));
    my_assert(56, 0, strncmp(local_strings[3], "local_really_long_string_more_than_eight", sizeof("local_really_long_string_more_than_eight") / sizeof(char)));
...
int test57(void) {
    ...
    my_assert(57, 0, strncmp(string, "thisisastring.", sizeof("thisisastring.") / sizeof(char)));
    return 0;
}
...
int test73_test_func(int a, int b, int c) {
    return a * b + c;
}
int test73(void) {
    int a = (3 + 3, 5);
